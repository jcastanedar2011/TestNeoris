...
//        => optionsBuilder.UseSqlServer("Server=DESKTOP-EHJ2MHT\\SQLEXPRESS; Database=TestNeoris; Integrated Security=true; TrustServerCertificate=true; user=sa; password=sa");
